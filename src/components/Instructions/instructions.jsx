...
export default function Instructions() {
  return (
    <Container fluid className="instCon">
      <Row><h2 style={{color: "black"}} className="text-center mt-4 fw-bolder keys">Instructions</h2></Row>
      ...
      <Row className="my-4 instructions d-flex justify-content-center fw-bolder keys dex">-Dexington</Row>

      <Row><h2 style={{color: "black"}} className="text-center mt-4 fw-bolder keys">Definitions</h2></Row>
      <Row className="mt-4 instructions">
        <Col className="fw-bolder keys" xs={3} md={3}>Power</Col>
        <Col xs={9} md={9}>The power's name</Col>
      </Row>
      <Row className="mt-4 instructions">
        <Col className="fw-bolder keys" xs={3} md={3}>Effect Time</Col>
        <Col xs={9} md={9}>Time after activation the projectile begins to travel, this factors in server ticks</Col>
      </Row>
      <Row className="mt-4 instructions">
        <Col className="fw-bolder keys" xs={3} md={3}>Projectile Speed</Col>
        <Col xs={9} md={9}>ft/second the attack travels at</Col>
      </Row>
      <Row className="mt-4 instructions">
        <Col className="fw-bolder keys" xs={3} md={3}>True Cast Time</Col>
